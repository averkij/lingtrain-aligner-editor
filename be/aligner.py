...
def calculate_graphs(lines_from, processing_from_to, res_img, res_img_path, res_path, lang_name_from, lang_name_to, threshold=config.DEFAULT_TRESHOLD, batch_size=config.DEFAULT_BATCHSIZE, window_size=config.DEFAULT_WINDOW):
    print("calculating...")
    # print(lines_from)
