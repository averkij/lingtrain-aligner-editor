<template>
  <div>
      ...
      <v-card-actions>
        ...
        <v-tooltip bottom>
          <template v-slot:activator="{ on, attrs }">
            <v-btn v-if="showUploadProxyBtn" @click="showUploadProxyPanel = true" v-bind="attrs" v-on="on">
    ...
    <v-card v-if="showUploadProxyPanel" class="mt-5">
      ...
      <v-card-text>Optionally add a translation for the downloaded file. Translation
